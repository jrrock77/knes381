...
# changed ability to play in spaces already occupied (fix 1)
...
# fixed game to allow new move when player tries to play in occupied square (fix 2), and added function to play again so you don't have to rerun the program (fix 3)
def play_game():
    while True:
        # initialize the game
        board = [["_" for i in range(3)] for j in range(3)]
        ...
        # ask the user if they want to start a new game or quit
        while True:
